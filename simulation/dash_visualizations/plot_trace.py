...
def plot_trace():
    try:
        df = pd.read_csv(os.path.join(output_dir, "trace.txt"), skipinitialspace=True)
        tf = pd.read_csv(os.path.join(output_dir, "tests.txt"), skipinitialspace=True)
...
if __name__=='__main__':
    plot_trace("../simulation_single_run/outputs/").show()
